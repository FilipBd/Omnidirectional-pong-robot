...
def regulate(robot):
	...
	while True:
		...
		# Due to interfering magnetic fields, the error is set to 0 if there is a sudden jump in the degreeError. 
		diff = e3_error - e3_prev_error
		...
		m1_speed, m2_speed, m3_speed = robot.wheels(X, 0, e3_adj)
